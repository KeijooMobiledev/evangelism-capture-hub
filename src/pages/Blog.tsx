...
import { blogPosts, getPostsByCategory, searchPosts } from '@/data/blogPosts';
...
const Blog = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (searchQuery.trim()) {
      ...
      setFilteredPosts(currentCategory === 'all' ? blogPosts : getPostsByCategory(currentCategory));
    }
  };
  ...
  const handleCategoryChange = (category: string) => {
    ...
    setSearchQuery('');
    setFilteredPosts(category === 'all' ? blogPosts : getPostsByCategory(category));
  };
